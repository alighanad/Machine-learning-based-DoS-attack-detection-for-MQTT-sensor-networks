...
client.loop_start()
client.subscribe("apartment/room_1/splug_1/timer")
...
while True:
    ...
    my_minute = int(my_current.minute)
    my_second = int(my_current.second)
    if my_hour==14 and my_minute==35 and my_second == 1:
        myMsg["Payload"] = states[0]
        data_out = json.dumps(myMsg)

        client.publish("apartment/room_1/splug_1/timer", data_out)
    elif my_hour ==15 and my_minute==10 and my_second == 1:
