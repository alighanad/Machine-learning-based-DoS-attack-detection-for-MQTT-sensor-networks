...
##MQTT
client = mqtt.Client("Smart-Camera")
...
client.loop_start()
client.subscribe("apartment/room_1/camera/state")
#JSON
event = 1
times = 1
...
while True:
    ...
    client.publish("apartment/room_1/camera/state", data_out)
client.loop_stop()
client.disconnect()